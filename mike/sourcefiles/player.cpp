...
void player::print_playerPeices()
{
   for (int pos=0;pos<40;pos++){
      cout<<"color:"<<playerPeices[pos]->color<<" rank:"<<playerPeices[pos]->rank<<" row"<<playerPeices[pos]->row
          <<" column:"<<playerPeices[pos]->column<<" peiceNumber:"<<playerPeices[pos]->peiceNumber<<endl;
   }
}
